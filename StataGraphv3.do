...
la var avmu "Average markups"
serrbar avmu sdmu year,ylabel(0(1)8) xlabel(#5,valuelabel) 
...
la var avmu "Average markups"
serrbar avmu sdmu Disic3 if Disic3<110, xlabel(#10,valuelabel) ylabel(,valuelabel)
...
use tfpdd,clear
sort year
twoway (line mui year if Disic4==1043,lp(longdash)) || (line mui year if Disic4==1063,lp(shortdash)) || (line mui year if Disic4==1072) ||,legend(label(1 "Vegetable oil") label(2 "Rice mill") label(3 "Sugar refinery")) title("markups in 3 industries") xlabel(,valuelabel)
